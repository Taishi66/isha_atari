...
function AppContent() {
    ...
    return (
        <ErrorBoundary>
            ...
            {/* Main Application */}
            <div
                className={`min-h-screen overflow-hidden relative transition-all duration-1000 ease-out ${isLoading
                    ? "opacity-0 scale-105 blur-sm"
                    : "opacity-100 scale-100 blur-0"
                    }`}
                style={{
                    background: currentTheme.id === 'solarized' ? 'linear-gradient(135deg, #002b36 0%, #073642 100%)' : '#000',
